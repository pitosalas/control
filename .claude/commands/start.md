...
6. Summarize: open features, next tasks, what was in progress.

**Process gate:** After the summary, stop. Do not write any code or content until the user has given explicit approval to proceed.
