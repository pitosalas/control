...
# Chip has exactly 6 registers — no hidden data beyond what's mapped here.
...
class INA219:
    ...
    def getBusVoltage_V(self):
        self.write(_REG_CALIBRATION,self._cal_value)
        self.read(_REG_BUSVOLTAGE)  # first read discarded — result unused
        return (self.read(_REG_BUSVOLTAGE) >> 3) * 0.004

    def getCurrent_mA(self):
        # Negative value = charging, positive = discharging
